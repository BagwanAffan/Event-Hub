    ...
    <section className="py-20 lg:py-32 bg-slate-50 dark:bg-slate-900/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative p-6 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">
            <div className="flex flex-col gap-4">
              <div className="flex gap-3 max-w-[80%] ml-auto">
                <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded-2xl rounded-tr-sm text-sm text-slate-700 dark:text-slate-300">
              ...
              <div className="flex gap-3 max-w-[90%]">
                ...
                <div className="bg-[#01424E]/5 dark:bg-[#7CEAAB]/10 border border-[#01424E]/10 dark:border-[#7CEAAB]/20 p-4 rounded-2xl rounded-tl-sm text-sm text-slate-800 dark:text-slate-200">
